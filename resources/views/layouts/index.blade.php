        ...
        <div class="section slider-section">
            ...
            <div class="container">
                ...
                <div class="slider-content">
                    ...
                    <a class="btn btn-primary btn-hover-dark" href="{{ route('app_login') }}">Commencer un cours</a>
                </div>
                <!-- Slider Content End -->
            ...
            <div class="slider-video">
                ...
                <div class="video-play">
                    ...
                    <a href="https://www.youtube.com/watch?v=5bENbVx1lfo" class="play video-popup"><i
            ...
            <div class="container">
                ...
                <div class="courses-top">
                    ...
                    <div class="section-title shape-01">
                        <h2 class="main-title">Quelques <span>Cours</span> de Eniola</h2>
                    </div>
                    <!-- Section Title End -->
                ...
                <div class="courses-btn text-center">
                    <a href="{{ route('app_courses') }}" class="btn btn-secondary btn-hover-primary">Voir plus de
                        cours</a>
                </div>
        ...
        <div class="section section-padding mt-n1">
            <div class="container">
                ...
                <div class="section-title shape-03 text-center">
                    <h5 class="sub-title">Plus de {{ count($Courses) }} cours</h5>
                ...
                <div class="how-it-work-wrapper">
                    ...
                    <div class="single-work">
                        ...
                        <div class="work-content">
                            ...
                            <p>Plusieurs cours sont disponibles sur Eniola pour vous ! Choisissez en-un et passez à l'étape
                                suivante.</p>
                        </div>
                    </div>
                    <!-- Single Work End -->
                    ...
                    <div class="single-work">
                        ...
                        <div class="work-content">
                            <h3 class="title">Inscrivez-vous à un cours</h3>
                            <p>Démarrez le cours vous ajoute ce cours dans votre tableau de bord où vous pouvez suivre votre
                                progression</p>
                        </div>
                    </div>
                    <!-- Single Work End -->
                    ...
                    <div class="single-work">
                        ...
                        <div class="work-content">
                            ...
                            <p>A la fin d'un cours, après avoir passé avec succès l'examen lié au cours, ENIOLA vous délivre
                                un bon certificat</p>
                        </div>
                    </div>
                    <!-- Single Work End -->
